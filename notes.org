...
** Moand stack idea
- Trying to write the computations outside the GhcMonad GhcT (ReaderT a m) b
- Coupling GhcMonad and other monad transformers through impure actions (ReaderT a (GhcT m) b)
